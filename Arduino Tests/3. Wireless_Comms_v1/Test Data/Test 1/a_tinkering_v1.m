...
file_path = "C:\Users\Nicholas Lamanna\Desktop\MFL Code\Arduino Tests\3. Wireless_Comms_v1\Test Data\Test 1\file_1.txt";
data = table2array(readtable(file_path));

%% Extract useful info from loaded data set
start = 855;                                        % 855 is where 'zero' signal ends for \Test 1\file_1.txt
