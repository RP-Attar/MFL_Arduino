...
file_path = "C:\Users\Nicholas Lamanna\Desktop\MFL Code\Arduino Tests\3. Wireless_Comms_v1\Test Data\Test 5\file_2 - no mag.txt";
data = table2array(readtable(file_path));

%% Extract useful info from loaded data set
start = 1252;                                       % 348 for 5.3
                                                    % 327 for 5.0
                                                    % 815 for - mag
                                                    % 1252 for - no mag
...
legend("hall 1 - top", "hall 2 - bottom (or normal sensor)")
