...
file_path = "C:\Users\Nicholas Lamanna\Desktop\MFL Code\Arduino Tests\3. Wireless_Comms_v1\Test Data\Test 3\file_2.txt";
data = table2array(readtable(file_path));

%% Extract useful info from loaded data set
start = 421;                                        % 644 is where 'zero' signal ends for \Test 3\file_1.txt,  421 is where 'zero' signal ends for \Test 3\file_2.txt
